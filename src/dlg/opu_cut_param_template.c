...
/*=============================================================================
   ...
   file is saved.
        ...
        Filename:  opu_cut_param_template.c
...
/*==============================================================================
   ...
   2.  The callback structure: --- MT_cbs ---               
...
#define MT_CB_COUNT ( 12 + 1 ) /* Add 1 for the terminator */
...
static UF_STYLER_callback_info_t MT_cbs[MT_CB_COUNT] = 
{
 ...
 {MT_STOCK_TOG_FINISH_PAS, UF_STYLER_VALUE_CHANGED_CB, 0, MT_stock_finish_tog_cb},
 {MT_STOCK_REAL_6       , UF_STYLER_ACTIVATE_CB     , 0, MT_real_cb},
 {MT_STOCK_REAL_7       , UF_STYLER_ACTIVATE_CB     , 0, MT_real_cb},
 {MT_STOCK_REAL_8       , UF_STYLER_ACTIVATE_CB     , 0, MT_real_cb},
...
4) You should also add the funcitonal prototype to your header file 
   (opu_cut_param.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "opu_cut_param.dlg",
...
/* -------------------------------------------------------------------------
 * Callback Name: MT_stock_finish_tog_cb
 * This is a callback function associated with an action taken from a
 * UIStyler object. 
 *
 * Input: dialog_id   -   The dialog id indicate which dialog this callback
